...
void LaunchMenu::initialise(bool& state)
{
	...
	if (f)
	{
		m_objects.push_back(new UI_Button("assets/UI/continue.png", { 0,0,128,64 }, { 416,234,128,64 }, RenderLayer::UI_Foreground, 1, "load"));
		m_objects.push_back(new UI_Button("assets/UI/new_game.png", { 0,0,128,64 }, { 416,384,128,64 }, RenderLayer::UI_Foreground, 2, "new"));
		m_objects.push_back(new UI_Button_Exit("assets/UI/exit.png", { 0,0,128,64 }, { 416,534,128,64 }, RenderLayer::UI_Foreground, 3, state));
		f.close();
	}
	else
	{
		m_objects.push_back(new UI_Button("assets/UI/new_game.png", { 0,0,128,64 }, { 416,284,128,64 }, RenderLayer::UI_Foreground, 1, "new"));
